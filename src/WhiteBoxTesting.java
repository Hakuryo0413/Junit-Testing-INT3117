...
class WhiteBoxTesting {
    ...
    void getPriceOfTicket4() {
        Ticket t4 = new Ticket("Economy Class", 2);
        assertEquals(700000, t4.getPriceOfTicket(t4.getFareClass(), t4.getAge()));
    }

    @Test
    void getPriceOfTicket5() {
        Ticket t5 = new Ticket("Economy Class", 60);
        assertEquals(3000000, t5.getPriceOfTicket(t5.getFareClass(), t5.getAge()));
    }
}